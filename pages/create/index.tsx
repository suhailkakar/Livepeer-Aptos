        ...
        {stream ? (
          <div className="w-1/2 mt-20">
            ...
            <p className="text-zinc-400 mt-4">
              Use these details to connect to Livepeer from streaming software
              like{" "}
              <Link
            ...
            <div className="flex flex-col mt-2">
              ...
              <div className="flex mt-2">
                <p className="font-regular text-zinc-500 w-32">Stream Key: </p>
                <p className="text-white ml-2">{stream.streamKey}</p>
              </div>

              <div className="flex mt-2">
                <p className="font-regular text-zinc-500 w-32">Ingest URL: </p>
            ...
            <div className="flex flex-row mt-4 justify-between">
              <div className="w-[42%]">
                <Input
                  ...
                  disabled={aptosTokenAmount ? true : false}
                />
              </div>
              ...
              <div className="w-[42%]">
                <Input
                  ...
                  disabled={assetAddress ? true : false}
